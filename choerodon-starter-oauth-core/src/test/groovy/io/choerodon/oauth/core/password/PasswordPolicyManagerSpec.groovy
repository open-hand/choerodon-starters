...
class PasswordPolicyManagerSpec extends Specification {
    ...
    def "test password Validate"() {
        ...
        def policy = new BasePasswordPolicyDTO()
    ...
    def "test is Need Captcha"() {
        ...
        when:
        def result = new PasswordPolicyManager(passwordStrategyStore, baseLoginAttemptTimesMapper).isNeedCaptcha(policy, new BaseUserDTO())
