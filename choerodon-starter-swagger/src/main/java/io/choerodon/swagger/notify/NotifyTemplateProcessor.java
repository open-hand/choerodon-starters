    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) {
        ...
        if (business != null) {
            businessTypeScanData.add(new NotifyBusinessTypeScanData(business.code(), business.name(), business.description(),
                    ...
                    business.pmEnabledFlag(), business.smsEnabledFlag(), business.webhookOtherEnabledFlag(), business.webhookJsonEnabledFlag(), business.targetUserType(), business.notifyType().getTypeName(),
