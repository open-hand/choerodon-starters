...
```
curl https://oss.sonatype.org/content/groups/public/io/choerodon/choerodon-tool-liquibase/0.10.1.RELEASE/choerodon-tool-liquibase-0.10.1.RELEASE.jar -o choerodon-tool-liquibase.jar
```
