...
```
curl https://oss.sonatype.org/content/groups/public/io/choerodon/choerodon-tool-liquibase/0.9.3.RELEASE/choerodon-tool-liquibase-0.9.3.RELEASE.jar -o choerodon-tool-liquibase.jar
```
