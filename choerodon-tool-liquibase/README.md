...
```
curl https://oss.sonatype.org/content/groups/public/io/choerodon/choerodon-tool-liquibase/0.8.0.RELEASE/choerodon-tool-liquibase-0.8.0.RELEASE.jar -o choerodon-tool-liquibase.jar
```
