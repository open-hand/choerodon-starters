...
```
curl https://oss.sonatype.org/content/groups/public/io/choerodon/choerodon-tool-liquibase/0.6.0-SNAPSHOT/choerodon-tool-liquibase-0.6.0-SNAPSHOT.jar -o choerodon-tool-liquibase.jar
```
* Example:
