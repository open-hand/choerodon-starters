...
then
    curl http://nexus.choerodon.com.cn/repository/choerodon-release/io/choerodon/choerodon-tool-liquibase/0.10.1.RELEASE/choerodon-tool-liquibase-0.10.1.RELEASE.jar -L  -o target/choerodon-tool-liquibase.jar
fi
