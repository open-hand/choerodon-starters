...
import io.choerodon.nacos.common.http.Callback;
import io.choerodon.nacos.common.http.HttpUtils;
import io.choerodon.nacos.common.http.client.handler.ResponseHandler;
import io.choerodon.nacos.common.http.client.request.AsyncHttpClientRequest;
...
public class NacosAsyncRestTemplate extends AbstractNacosRestTemplate {
     ...
     * @param callback     callback {@link Callback#onReceive(io.choerodon.nacos.common.model.RestResult)}
     */
