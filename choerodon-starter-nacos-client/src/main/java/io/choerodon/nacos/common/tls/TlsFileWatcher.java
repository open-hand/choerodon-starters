...
package io.choerodon.nacos.common.tls;

import io.choerodon.nacos.api.common.Constants;
import io.choerodon.nacos.common.executor.ExecutorFactory;
import io.choerodon.nacos.common.executor.NameThreadFactory;
...
public final class TlsFileWatcher {
    ...
    private final ScheduledExecutorService service = ExecutorFactory.Managed
            .newSingleScheduledExecutorService(ClassUtils.getCanonicalName(TlsFileWatcher.class),
                    new NameThreadFactory("io.choerodon.nacos.core.common.tls"));
