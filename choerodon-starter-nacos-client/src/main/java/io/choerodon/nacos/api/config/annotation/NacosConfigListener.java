...
package io.choerodon.nacos.api.config.annotation;

import io.choerodon.nacos.api.annotation.NacosProperties;
import io.choerodon.nacos.api.common.Constants;
import io.choerodon.nacos.api.config.ConfigType;
import io.choerodon.nacos.api.config.convert.NacosConfigConverter;

import java.lang.annotation.*;

import static io.choerodon.nacos.api.common.Constants.DEFAULT_GROUP;
