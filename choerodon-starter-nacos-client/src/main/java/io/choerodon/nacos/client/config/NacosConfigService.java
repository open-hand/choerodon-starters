...
package io.choerodon.nacos.client.config;
...
import io.choerodon.nacos.api.config.ConfigType;
import io.choerodon.nacos.api.config.listener.Listener;
import io.choerodon.nacos.api.exception.NacosException;
import io.choerodon.nacos.client.config.filter.impl.ConfigFilterChainManager;
import io.choerodon.nacos.client.config.filter.impl.ConfigRequest;
import io.choerodon.nacos.client.config.filter.impl.ConfigResponse;
...
import io.choerodon.nacos.client.config.impl.ClientWorker;
import io.choerodon.nacos.client.config.impl.LocalConfigInfoProcessor;
import io.choerodon.nacos.client.config.utils.ContentUtils;
import io.choerodon.nacos.client.config.utils.ParamUtils;
import io.choerodon.nacos.client.utils.LogUtils;
import io.choerodon.nacos.client.utils.ParamUtil;
...
public class NacosConfigService implements ConfigService {
    ...
    @Override
    public boolean publishConfig(String tenant, String dataId, String group, String content, String type) throws NacosException {
        return publishConfigInner(tenant, dataId, group, null, null, null, content, type);
    }

    @Override
    public boolean publishConfig(String tenant, String dataId, String group, String content, String betaIps, String type) throws NacosException {
        return publishConfigInner(tenant, dataId, group, null, null, betaIps, content, type);
    }

    @Override
    public boolean publishConfig(String tenant, String dataId, String group, String tag, String appName, String betaIps, String content, String type) throws NacosException {
        return publishConfigInner(tenant, dataId, group, tag, appName, betaIps, content, type);
    }
    ...
    @Override
    public boolean removeConfig(String tenant, String dataId, String group) throws NacosException {
        return removeConfigInner(tenant, dataId, group, null);
    }
