...
package io.choerodon.nacos.client.naming.net;

import io.choerodon.nacos.api.PropertyKeyConst;
import io.choerodon.nacos.api.SystemPropertyKeyConst;
import io.choerodon.nacos.api.common.Constants;
import io.choerodon.nacos.api.exception.NacosException;
import io.choerodon.nacos.api.naming.CommonParams;
import io.choerodon.nacos.api.naming.pojo.Instance;
import io.choerodon.nacos.api.naming.pojo.ListView;
import io.choerodon.nacos.api.naming.pojo.Service;
import io.choerodon.nacos.api.selector.AbstractSelector;
import io.choerodon.nacos.api.selector.ExpressionSelector;
import io.choerodon.nacos.api.selector.SelectorType;
import io.choerodon.nacos.client.config.impl.SpasAdapter;
import io.choerodon.nacos.client.monitor.MetricsMonitor;
import io.choerodon.nacos.client.naming.beat.BeatInfo;
import io.choerodon.nacos.client.naming.utils.CollectionUtils;
import io.choerodon.nacos.client.naming.utils.NetUtils;
import io.choerodon.nacos.client.naming.utils.SignUtil;
import io.choerodon.nacos.client.naming.utils.UtilAndComs;
import io.choerodon.nacos.client.security.SecurityProxy;
import io.choerodon.nacos.client.utils.AppNameUtils;
import io.choerodon.nacos.client.utils.TemplateUtils;
import io.choerodon.nacos.common.constant.HttpHeaderConsts;
import io.choerodon.nacos.common.http.HttpRestResult;
import io.choerodon.nacos.common.http.client.NacosRestTemplate;
import io.choerodon.nacos.common.http.param.Header;
import io.choerodon.nacos.common.http.param.Query;
import io.choerodon.nacos.common.lifecycle.Closeable;
import io.choerodon.nacos.common.utils.*;
...
import static io.choerodon.nacos.client.utils.LogUtils.NAMING_LOGGER;
    ...
    private void initRefreshTask() {
        ...
        this.executorService = new ScheduledThreadPoolExecutor(2, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("io.choerodon.nacos.client.naming.updater");
                t.setDaemon(true);
                return t;
            }
        });
