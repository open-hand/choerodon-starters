...
package io.choerodon.nacos.client.naming.core;
...
import io.choerodon.nacos.client.naming.backups.FailoverReactor;
import io.choerodon.nacos.client.naming.beat.BeatInfo;
import io.choerodon.nacos.client.naming.beat.BeatReactor;
import io.choerodon.nacos.client.naming.cache.DiskCache;
import io.choerodon.nacos.client.naming.event.InstancesChangeEvent;
import io.choerodon.nacos.client.naming.event.InstancesChangeNotifier;
import io.choerodon.nacos.client.naming.net.NamingProxy;
...
import io.choerodon.nacos.common.notify.NotifyCenter;
import io.choerodon.nacos.common.utils.JacksonUtils;
import io.choerodon.nacos.common.utils.StringUtils;
import io.choerodon.nacos.common.utils.ThreadUtils;
    ...
    public HostReactor(NamingProxy serverProxy, BeatReactor beatReactor, String cacheDir, boolean loadCacheAtStart,
        ...
        this.executor = new ScheduledThreadPoolExecutor(pollingThreadCount, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                thread.setName("io.choerodon.nacos.client.naming.updater");
                return thread;
            }
        });
