...
package io.choerodon.nacos.client.config.http;
...
import io.choerodon.nacos.client.config.impl.ConfigHttpClientManager;
import io.choerodon.nacos.client.config.impl.ServerListManager;
import io.choerodon.nacos.client.config.impl.SpasAdapter;
import io.choerodon.nacos.client.identify.StsConfig;
import io.choerodon.nacos.client.security.SecurityProxy;
import io.choerodon.nacos.client.utils.ContextPathUtil;
    ...
    public ServerHttpAgent(Properties properties) throws NacosException {
        ...
        this.executorService = new ScheduledThreadPoolExecutor(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("io.choerodon.nacos.client.config.security.updater");
                t.setDaemon(true);
                return t;
            }
        });
