...
package io.choerodon.nacos.client.naming.backups;

import io.choerodon.nacos.api.exception.NacosException;
import io.choerodon.nacos.api.naming.pojo.ServiceInfo;
import io.choerodon.nacos.client.naming.cache.ConcurrentDiskUtil;
    ...
    public FailoverReactor(HostReactor hostReactor, String cacheDir) {
        ...
        this.executorService = new ScheduledThreadPoolExecutor(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                thread.setName("io.choerodon.nacos.naming.failover");
                return thread;
            }
        });
        this.init();
