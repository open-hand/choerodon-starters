...
package io.choerodon.nacos.client.config.impl;
...
import io.choerodon.nacos.client.config.common.GroupKey;
...
import io.choerodon.nacos.client.utils.TenantUtil;
import io.choerodon.nacos.common.http.HttpRestResult;
import io.choerodon.nacos.common.lifecycle.Closeable;
import io.choerodon.nacos.common.utils.ConvertUtils;
import io.choerodon.nacos.common.utils.MD5Utils;
...
import static io.choerodon.nacos.api.common.Constants.*;
    ...
    public ClientWorker(final HttpAgent agent, final ConfigFilterChainManager configFilterChainManager,
        ...
        this.executor = Executors.newScheduledThreadPool(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("io.choerodon.nacos.client.Worker." + agent.getName());
                t.setDaemon(true);
                return t;
            }
        });
        ...
        this.executorService = Executors
                .newScheduledThreadPool(Runtime.getRuntime().availableProcessors(), new ThreadFactory() {
                    ...
                    public Thread newThread(Runnable r) {
                        Thread t = new Thread(r);
                        t.setName("io.choerodon.nacos.client.Worker.longPolling." + agent.getName());
                        t.setDaemon(true);
                        return t;
                    }
                });
