...
import io.choerodon.nacos.common.utils.VersionUtils;
...
public class UtilAndComs {
    ...
    public static final String NACOS_NAMING_LOG_NAME = "io.choerodon.nacos.naming.log.filename";
    
    public static final String NACOS_NAMING_LOG_LEVEL = "io.choerodon.nacos.naming.log.level";
