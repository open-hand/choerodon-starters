...
```
curl https://oss.sonatype.org/content/groups/public/io/choerodon/choerodon-tool-liquibase/0.9.2.RELEASE/choerodon-tool-config-0.9.2.RELEASE.jar -o choerodon-tool-config.jar
```
...
then
    curl https://oss.sonatype.org/content/groups/public/io/choerodon/choerodon-tool-liquibase/0.9.2.RELEASE/choerodon-tool-config-0.9.2.RELEASE.jar -o target/choerodon-tool-config.jar # The version may be changed here. Please change it based on the downloaded package name.
fi
