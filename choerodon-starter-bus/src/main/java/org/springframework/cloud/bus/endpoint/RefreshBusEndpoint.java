...
public class RefreshBusEndpoint extends AbstractBusEndpoint {
    ...
    public void refresh(
            ...
            @RequestParam(value = "config_version", required = false) String configVersion) {
        publish(new RefreshRemoteApplicationEvent(this, getInstanceId(), destination, instanceId, configVersion));
    }
