...
public class BusAutoConfiguration implements ApplicationEventPublisherAware {
    ...
    public void acceptRemote(RemoteApplicationEvent event) {
        ...
        if (this.bus.getTrace().isEnabled() && this.applicationEventPublisher != null) {
            ...
            this.applicationEventPublisher.publishEvent(new SentApplicationEvent(this,
                    ...
                    event.getId(), event.getDestinationInstance(),
                    event.getConfigVersion(), event.getClass()));
        }
    }
    ...
    protected static class BusRefreshConfiguration {
        ...
        public RefreshListener refreshListener(ContextRefresher contextRefresher, EnvironmentManager environmentManager) {
            return new RefreshListener(environmentManager, contextRefresher);
        }
